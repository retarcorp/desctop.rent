<?php
    ...
    class DateUtil{
        ...
        public static function toRussian($arg, bool $withoutSecs = false): string{
            return self::toRussianFormat($arg, $withoutSecs);
        }
        ...
        public static function toSql($arg, bool $withoutSecs = false): string{
            return self::toSqlFormat($arg, $withoutSecs);
        }
