<section id="fileManager" class="right-tab__tab-data tab-data active">
    <header class="tab__header">
        <ul class="header__nav-path text_color_grey">
            ...
            <li class="header__list-item"><a href="#" class="text_color_blue">Мои базы 1С</a></li>
        </ul>
        <h1 class="header__text text_size_header">Мои базы 1С</h1>
    </header>
    ...
    <!--</header>-->
        ...
        <div class="folders__tab active">
            <button class="button button_theme_sky-dark save__button_size loader_relative folder__tab-btn" id="createFolder" @click="openCreatePopUpFolder">
                <span class="button_text button__text_color button__text_size_small font-regular">Создать базу</span>
            </button>
            <header class="foldes__header baseC">
                <div class="header__col header__base font-regular">Название базы</div>
                <div class="header__col header__config font-regular">Конфигурация</div>
                <div class="header__col header__hold font-regular"></div>
                <div class="header__col header__button font-regular"></div>
            </header>
            <div class="folders__container" @click.stop="toggleFolderContent">
                
                <div class="folders__folder">
                    <p class="base__name font-regular">ООО “ОлдСкулл”</p>
                    <p class="config__value font-regular">Управление наше фирмой, и документами</p>
                    <input class="base__check style-ratio" type="checkbox" name="font_print">
        ...
        <div class="scaners__tab">
            ...
            <header class="foldes__header">
                <div class="header__col header__folders">Список сканеров</div>
                <div class="header__col header__button"></div>
            </header>
            <div class="folders__container" @click.stop="toggleFolderContent">
                
                <div class="folders__folder">
                    <p class="folder__title">Сканер</p>
                    <div class="folder__btn">
                        <button class="folder__item button__folder-edit"></button>
                        <button class="folder__item button__folder-remove"></button>
                    </div>
                ...
                <div class="folders__folder">
                    <p class="folder__title">Архивы сотрудников</p>
                    <div class="folder__btn">
                        <button class="folder__item button__folder-edit"></button>
                        <button class="folder__item button__folder-remove"></button>
                    </div>
    ...
    <section class="new-folder__background" style="display:none;">
        <div class="popup new-folder">
            <h1 class="popup__header font-regular">Создать базу</h1>
            <button class="popup__btn-close"></button>
            ...
            <div class="new-folder__access">
                <div class="field__container">
                    ...
                    <div class="tab-data__field field field_margin_bottom">
                        <label for="name" class="field__label">
                            <span class="text_size_small text_color_dark font-regular">Конфигурация</span>
                        </label> 
                        <select class="right-list font-regular field__input text_size_small">
            ...
            <button class="button btn__save-newfolder font-regular margin_create">Создать</button>
        </div>
    </section>
    ...
    <section class="new-folder__background" style="display:none;">
        <div class="popup popup__remove-size new-folder">
            <h1 class="popup__header font-regular">Внимание!</h1>
            <button class="popup__btn-close"></button>
            <div class="new-folder__access">
                <p class="error__value font-regular">Error text!</p>
                <div class="tab-data__save save save_margin">
                    <button class="button button_theme_sky-dark save__button_size loader_relative" id=''> 
                        <span class="button_text button__text_color button__text_size_small font-regular">Да</span>
                    </button>
