	...
	RT = {
		...
		,postJSON: function(path, data, onSuccess, onError){
            _.post(path, data, function(r){
                var d;
                try{
                    d = JSON.parse(r);
                }catch(e){
		...
		,getJSON: function(path, data, onSuccess, onError){
            _.get(path, data, function(r){
                var d;
                try{
                    d = JSON.parse(r);
                }catch(e){
		...
		,post: function(p,d,f,onerror){
		    ...
		    var s = "";
		    for(var prop in d){
		        fd.push(encodeURIComponent(prop)+"="+encodeURIComponent(d[prop]));   
		    }
		    fd = s+fd.join("&");
		...
		,put: function(p,d,f,o){
		    var xhr = new XMLHttpRequest;
	
		    var fd = new FormData;
		    var s = "";
		    for(var prop in d){
		        fd.append(prop,d[prop]);   
		    }
